...
fs.rename("packages/playwright-core", "packages/patchright-core", (err) => {
    fs.rename("packages/playwright", "packages/patchright", (err) => {
        ...
        // Read the content of packages/patchright/lib/transform/babelBundleImpl.js
        fs.readFile("packages/patchright/lib/transform/babelBundleImpl.js", "utf8", (err, data) => {
            if (err) {
            ...
            fs.writeFile("packages/patchright/lib/transform/babelBundleImpl.js", updatedContent, "utf8", (err) => {
                if (err) {
